...
static PARAMS: &[ParamDef] = &[
    ParamDef { key: "asset_id", default: || ParamValue::String(String::new()), ui: ParamUi::Hidden },
    ParamDef { key: "asset_path", default: || ParamValue::String(String::new()), ui: ParamUi::Hidden },
    ParamDef { key: "resolution", default: || ParamValue::UInt(256), ui: ParamUi::UIntFree },
    ParamDef { key: "sampling", default: || ParamValue::String("smooth".to_string()), ui: ParamUi::Text },
];
