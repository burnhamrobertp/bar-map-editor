...
static PARAMS: &[ParamDef] = &[
    ParamDef { key: "mode", default: || ParamValue::String("ridges".to_string()), ui: ParamUi::Choices(super::shared::CONVEXITY_MODES) },
    ParamDef { key: "strength", default: || ParamValue::Float(1.0), ui: ParamUi::FloatRange { min: 0.1, max: 8.0 } },
];
