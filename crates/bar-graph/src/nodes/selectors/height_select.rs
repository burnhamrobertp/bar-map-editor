...
static PARAMS: &[ParamDef] = &[
    ParamDef { key: "low", default: || ParamValue::Float(0.3), ui: ParamUi::FloatRange { min: 0.0, max: 1.0 } },
    ParamDef { key: "high", default: || ParamValue::Float(0.7), ui: ParamUi::FloatRange { min: 0.0, max: 1.0 } },
    ParamDef { key: "falloff", default: || ParamValue::Float(0.1), ui: ParamUi::FloatRange { min: 0.0, max: 0.5 } },
