...
static RIDGED_PARAMS: &[ParamDef] = &[
    ParamDef { key: "character", default: || ParamValue::String("ridges".to_string()), ui: ParamUi::Choices(shared::RIDGED_CHARACTERS) },
    ParamDef { key: "frequency", default: || ParamValue::Float(2.0), ui: ParamUi::FloatRange { min: 0.1, max: 128.0 } },
