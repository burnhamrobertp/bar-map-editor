...
///
/// This is the post-evaluation phase: the graph has already been evaluated,
/// and we now collect layers from each bundler's connected inputs and
/// invoke the appropriate codec + packager.
